    ...
    items: [
      {
        ...
        description:
          "Gerencie valores, parcelas e recebimentos dos seus clientes.",
      },
      {
        id: "contas-pagar",
        ...
        description:
          "Gerencie as obrigações financeiras, pagamentos e vencimentos da empresa.",
      },
      {
        id: "fluxo-caixa",
      ...
      },
      {
        ...
        code: "F4",
        path: "/app/financeiro/caixa-bancos",
        description:
